...
if "components" in open_api_data:
    if "schemas" in open_api_data["components"]:
        open_api_data["components"]["schemas"] = dict(sorted(open_api_data["components"]["schemas"].items()))
